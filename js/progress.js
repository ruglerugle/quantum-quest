...
(function (global) {
  ...
  var STORAGE_KEY = "quantumQuestProgress";
  ...
  var STAGES = [
    { n: 1, file: "stage1.html", title: "光は波？ それとも粒？", sub: "二重スリット実験" },
    { n: 2, file: "stage2.html", title: "光は粒でもあった", sub: "光電効果と光子" },
    ...
    { n: 6, file: "stage6.html", title: "シュレーディンガー方程式", sub: "井戸の中の電子を解く" },
    { n: 7, file: "stage7.html", title: "トンネル効果と猫", sub: "壁抜けと重ね合わせ" },
