...
(function (global) {
  ...
  var STORAGE_KEY = "kennardQuestProgress_v2";
  ...
  var STAGES = [
    { n: 1, file: "stage1.html", title: "1927年の宿題", sub: "「ばらつき」を数学にする" },
    { n: 2, file: "stage2.html", title: "確率の波と積分", sub: "平均と Δx を式で書く" },
    { n: 3, file: "stage3.html", title: "運動量をつかまえる", sub: "微分という検出器" },
    { n: 4, file: "stage4.html", title: "部分積分の魔法", sub: "証明の弾丸を2つ込める" },
    { n: 5, file: "stage5.html", title: "魔法の関数 I(λ)", sub: "証明はこうして発見される" },
    { n: 6, file: "stage6.html", title: "判別式でフィニッシュ", sub: "中学数学が定理を倒す" },
    { n: 7, file: "stage7.html", title: "等号の波と歴史", sub: "ガウス波束とその後の物語" }
  ];
