...
(function (global) {
  ...
  var STORAGE_KEY = "quantumComputerQuestProgress_v5";

  var BOOK_RECOMMEND = {
    title: "竹内繁樹『量子コンピュータ 超並列計算のからくり』（ブルーバックス）",
    url: "https://www.amazon.co.jp/dp/4062574691?tag=senjin-22"
  };
  ...
  var STAGES = [
    ...
    { n: 2, file: "stage2.html", title: "量子ゲート", sub: "2列の対応表と掛け算" },
    { n: 3, file: "stage3.html", title: "アダマールゲート", sub: "和と差を作る主役" },
