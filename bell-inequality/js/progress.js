...
(function (global) {
  ...
  var STORAGE_KEY = "bellQuestProgress_v2";
  ...
  var STAGES = [
    { n: 1, file: "stage1.html", title: "月は見ていなくても存在するか", sub: "アインシュタインの疑問" },
    { n: 2, file: "stage2.html", title: "もつれた光子のふしぎな一致", sub: "偏光と完全相関" },
    { n: 3, file: "stage3.html", title: "数え上げで不等式を導く", sub: "説明書モデルからベルの不等式へ" },
    { n: 4, file: "stage4.html", title: "量子力学の予言", sub: "食い違いは sin²(角度差)" },
    { n: 5, file: "stage5.html", title: "実験による決着", sub: "アスペからノーベル賞まで" },
    { n: 6, file: "stage6.html", title: "月への答え", sub: "局所実在論のその後" }
  ];
